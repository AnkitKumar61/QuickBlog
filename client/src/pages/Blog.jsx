...
const Blog = () => {
  ...
  return data ?(
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'> {/* This section will contain:
                    1. Published Date
                    2. Title
                    3. subTitle
                    4. Author Name
      ...
      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'> {/*THis section will contain:
                    1. Blog Thumbnail image
                    2. Blog Description
                    3. Comments and comments Box
                    4. Social media icon */}
        ...
        <div className='flex flex-col gap-4'>
          {comments.map((item,index)=>(
            ...
            border-primary/5 max-w-xl p-4 rounded text-gray-600'>
              ...
              <div className='absolute right-4 bottom-3 flex items-center gp-2 text-xs'>{Moment(item.createdAt).fromNow()}</div>
...
{/* Add Comments Box*/}
      <div className='max-w-3xl mx-auto'>
        ...
        <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
          ...
          <input onChange={(e) => setName(e.target.value)} value = {name} type="text" placeholder='Name' className='w-full p-2
      ...
      {/* Share Buttons (Social Media icon) */}
