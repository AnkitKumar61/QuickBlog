...
const BlogTableItem = ({blog, fetchBlogs, index}) => {
    ...
    const BlogData = new Date(createdAt)  // we converted createdAt to js date object
  ...
  return (
    <tr className='border-y border-gray-300'>
        ...
        <td className='px-2 py-4 flex text-xs gap-3'>
            <button onClick={togglePublish} className='border px-2 py-0.5 mt-1 rounded cursor-pointer bg-blue-100'>{blog.isPublished ? 'Unpublish' : 'Publish'}</button>
